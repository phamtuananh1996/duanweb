...
<link rel="stylesheet" type="text/css" href="{{ asset('js/alert/sweetalert.css') }}">
   ...
   .error{
	...
	<div class="col-md-12 main-content" style="border: solid 1px green; background: white;">
						...
						<form action="" method="post">
							...
							<div class="col-md-12">
								<div class="row">
									...
									@if ($loop->index>0)
									<a href="#nothing"  id="delete"><span class="glyphicon glyphicon-remove"></span> Xóa </a>
									@endif	
								</div>
								...
								<div class="row">
									<div class="col-md-8">
										<div class="form-group pmd-textfield">
											...
											<input type="text" required name="explan"  class="form-control" value="{{$multiChoiceTests->explan}}">
										</div>	
									</div>
								</div>
										...
										<div class="row">
											...
											<div class="col-md-4" style="margin-top:15px;">
												<div class="checkbox pmd-default-theme">
													...
													@if ($loop->index>1)
														 <a href="#nothing" style="margin-left: 20px;"  id="delete_answer"><span class="glyphicon glyphicon-remove"></span> Xóa </a>
													@endif
